...
if __name__ == "__main__":
    ...
    parser.add_argument("-dn", "--data_name", type=str, help="Dataset name.", default="cleared_train")
    parser.add_argument("-df", "--data_file", type=str, help="Path to dataset.", default="../Datasets/cleared_train.tsv")
